...
export class ClientesService {
  ...
  service:string = 'Cliente';


  constructor(private http:HttpClient, private cookieService: CookieService) { }

  Create(request:any):Observable<any>{
    return this.http.post<any>(`${environment.apiBaseUrl}/api/${this.service}/CrearCliente`,request);
  }

  GetClientes():Observable<any[]>{
    return this.http.get<any[]>(`${environment.apiBaseUrl}/api/${this.service}/GetClientes`);
  }
